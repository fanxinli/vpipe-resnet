...
def model(criterion):
    ...
    for i in range(len(outputs)):
        modules.append((Stage(inputs[i], outputs[i], declares[i], calculations[i], recompute_ratio[i]), replace(inputs[i]), outputs[i]))
    modules.append((criterion, outputs[-1], ["loss"]))
...
self.layer12 = torch.nn.ReLU(inplace=False)
...
self.layer17 = torch.nn.ReLU(inplace=False)
...
self.layer23 = torch.nn.ReLU(inplace=False)
...
self.layer30 = torch.nn.ReLU(inplace=False)
...
self.layer37 = torch.nn.ReLU(inplace=False)
...
self.layer42 = torch.nn.ReLU(inplace=False)
...
self.layer45 = torch.nn.ReLU(inplace=False)
...
self.layer52 = torch.nn.ReLU(inplace=False)
...
self.layer55 = torch.nn.ReLU(inplace=False)
...
self.layer59 = torch.nn.ReLU(inplace=False)
...
self.layer62 = torch.nn.ReLU(inplace=False)
...
self.layer65 = torch.nn.ReLU(inplace=False)
...
self.layer69 = torch.nn.ReLU(inplace=False)
...
self.layer72 = torch.nn.ReLU(inplace=False)
...
self.layer75 = torch.nn.ReLU(inplace=False)
...
self.layer79 = torch.nn.ReLU(inplace=False)
...
self.layer82 = torch.nn.ReLU(inplace=False)
...
self.layer85 = torch.nn.ReLU(inplace=False)
...
self.layer91 = torch.nn.ReLU(inplace=False)
...
self.layer94 = torch.nn.ReLU(inplace=False)
...
self.layer97 = torch.nn.ReLU(inplace=False)
...
self.layer101 = torch.nn.ReLU(inplace=False)
...
self.layer104 = torch.nn.ReLU(inplace=False)
...
self.layer107 = torch.nn.ReLU(inplace=False)
...
self.layer111 = torch.nn.ReLU(inplace=False)
...
self.layer114 = torch.nn.ReLU(inplace=False)
...
self.layer117 = torch.nn.ReLU(inplace=False)
...
self.layer121 = torch.nn.ReLU(inplace=False)
...
self.layer124 = torch.nn.ReLU(inplace=False)
...
self.layer127 = torch.nn.ReLU(inplace=False)
...
self.layer131 = torch.nn.ReLU(inplace=False)
...
self.layer134 = torch.nn.ReLU(inplace=False)
...
self.layer137 = torch.nn.ReLU(inplace=False)
self.layer138 = torch.nn.Conv2d(256, 1024, kernel_size=(1, 1), stride=(1, 1), bias=False)
self.layer139 = torch.nn.BatchNorm2d(1024, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer141 = torch.nn.ReLU(inplace=False)
self.layer142 = torch.nn.Conv2d(1024, 512, kernel_size=(1, 1), stride=(1, 1), bias=False)
self.layer143 = torch.nn.BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer144 = torch.nn.ReLU(inplace=False)
self.layer145 = torch.nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
self.layer146 = torch.nn.BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer147 = torch.nn.ReLU(inplace=False)
self.layer148 = torch.nn.Conv2d(512, 2048, kernel_size=(1, 1), stride=(1, 1), bias=False)
self.layer149 = torch.nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer150 = torch.nn.Conv2d(1024, 2048, kernel_size=(1, 1), stride=(2, 2), bias=False)
self.layer151 = torch.nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer153 = torch.nn.ReLU(inplace=False)
self.layer154 = torch.nn.Conv2d(2048, 512, kernel_size=(1, 1), stride=(1, 1), bias=False)
self.layer155 = torch.nn.BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer156 = torch.nn.ReLU(inplace=False)
self.layer157 = torch.nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
self.layer158 = torch.nn.BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer159 = torch.nn.ReLU(inplace=False)
self.layer160 = torch.nn.Conv2d(512, 2048, kernel_size=(1, 1), stride=(1, 1), bias=False)
self.layer161 = torch.nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer163 = torch.nn.ReLU(inplace=False)
self.layer164 = torch.nn.Conv2d(2048, 512, kernel_size=(1, 1), stride=(1, 1), bias=False)
self.layer165 = torch.nn.BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer166 = torch.nn.ReLU(inplace=False)
self.layer167 = torch.nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
self.layer168 = torch.nn.BatchNorm2d(512, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer169 = torch.nn.ReLU(inplace=False)
self.layer170 = torch.nn.Conv2d(512, 2048, kernel_size=(1, 1), stride=(1, 1), bias=False)
self.layer171 = torch.nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
self.layer173 = torch.nn.ReLU(inplace=False)
self.layer174 = torch.nn.AvgPool2d(kernel_size=7, stride=1, padding=0)
self.layer177 = torch.nn.Linear(in_features=2048, out_features=1000, bias=True)'''
...
out150 = self.layer150(out141)
out151 = self.layer151(out150)
out151 = out151 + out149
...
out171 = out171 + out163
out173 = self.layer173(out171)
out174 = self.layer174(out173)
out175 = out174.size(0)
out176 = out174.view(out175, -1)
